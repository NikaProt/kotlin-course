...
// Для каждого задания опиши в коде базовый класс с базовыми свойствами и
// если применимо - методами.

//Для производных классов также добавь специфичные для класса свойства.
// Детально описывать не нужно, упражнение на то, чтобы усвоить иерархию
// наследования и развитие функциональности у наследников.
...
//Первый класс должен вставлять строку на дно контейнера (должно появиться под
// индексом 0)

//Второй класс должен получать список строк и вставлять их в начало контейнера но
// поочерёдно с теми данными, которые уже есть. То-есть, наш список должен
