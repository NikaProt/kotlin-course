...
// пишется маленькими буквами false
//val v6: = FALSE
...
// если это текст то нужны другие ковычки "", если это Double то без ковычек
//val v20 = `1.414`

val v21: String = "Artificial Intelligence"

//смешаны типы данных Char и String
//val v22 = arrayOf('x', "A")
...
// пришется маленькими буквами true
//val v44 = TRUE
...
val ticketText: String = "починилось само"

//Хранить список тем для митингов, которые на самом деле никому не нужны.
val meetingTopics: List<String> = listOf("Тема_01", "Тема_02", "Тема_03")